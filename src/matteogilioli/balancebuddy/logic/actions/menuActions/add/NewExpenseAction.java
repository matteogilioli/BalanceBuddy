...
/**
 * Un'{@link AbstractAction} del {@link MenuBar Menubar} per aggiungere un'uscita.
 */
public class NewExpenseAction extends AbstractAction {
    /**
     * Oggetto {@link BalanceTableModel} che dovrà essere aggiornato, una volta aggiunta l'uscita.
     */
     ...
     */
    public NewExpenseAction(String name, BalanceTableModel tableModel) {
        super(name);
        this.tableModel = tableModel;
    }

    /**
     * Crea un {@link FormDialog} per aggiungere un'uscita.
     *
